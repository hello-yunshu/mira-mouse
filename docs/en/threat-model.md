...
- Use atomic state/plugin replacement, immutable locks, protected environments, explicit GitHub Action refs, minimal permissions, and clean-job redownload verification.
