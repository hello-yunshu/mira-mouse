...
const required = ['README.md', 'LICENSE', 'LICENSES/AGPL-3.0-or-later.txt', 'LICENSES/CC-BY-SA-4.0.txt', 'NOTICE', 'SECURITY.md', 'CITATION.cff', 'docs/final-verification-report.md'];
